...
const size_t ENOUGH_KERNEL_SIZE_IN_SIGMAS = 8;
}  // namespace filters::utils::gaussian_blur

namespace filters::utils::matrices {
const std::vector<double> GRAYSCALE_COLOR_RATIO = {0.114, 0.587, 0.299};
const std::vector<std::vector<double>> SHARPENNING = {{0, -1, 0}, {-1, 5, -1}, {0, -1, 0}};
const std::vector<std::vector<double>> EDGE_DETECTING = {{0, -1, 0}, {-1, 4, -1}, {0, -1, 0}};
}  // namespace filters::utils::matrices
