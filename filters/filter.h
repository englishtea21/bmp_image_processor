...
namespace filters
{
    ...
    protected:
        ...
        Pixel<ComputationType> GetPixelViaConvolution(const std::vector<std::vector<Pixel<InputType>>> &image_bmp_matrix, size_t y,
                                                      size_t x, bool transpose_matrix = false) const
        {
